...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):  # clip-vit-base-patch32
        ...
        self.max_length = max_length   # TODO: typical value?
        self.freeze()
        self.return_last_token_inds = False
    ...
    def forward(self, text):
        ...
        # return last token inds exactly once if requested
        if self.return_last_token_inds:
            self.return_last_token_inds = False
            last_token_inds = tokens.argmax(dim=-1)
            return z, last_token_inds
...
if __name__ == "__main__":
    ...
    model = FrozenCLIPImageEmbedder().cuda()
